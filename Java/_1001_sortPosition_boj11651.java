...
public class _1001_sortPosition_boj11651 {
    public static void main(String[] args) throws IOException {
        ...
        arr.sort(new Comparator11651_1().thenComparing(new Comparator11651_2()));
...
class Comparator11651_1 implements Comparator<List<Integer>> {
...
class Comparator11651_2 implements Comparator<List<Integer>> {
